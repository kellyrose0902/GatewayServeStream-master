...
/**
 * Created by Kelly on 11/20/2015.
 */
public class AnimatedExpandableListView extends ExpandableListView{
    ...
    public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(AnimatedExpandableListView listView, int groupPosition) {
            long packedPosition = AnimatedExpandableListView.getPackedPositionForGroup(groupPosition);
